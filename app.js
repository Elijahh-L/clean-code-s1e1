...
var createNewTaskElement=function(taskString){
  ...
  var deleteButtonImg=document.createElement("img");//delete button image
	deleteButtonImg.classList.add("list__delete-image");
  ...
  editInput.type="text";
	editInput.classList.add("task-text", "list-input", "task");

  editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
  editButton.classList.add("list__button", "button", "edit-task")

  deleteButton.classList.add("list__button", "button", "delete-task")
